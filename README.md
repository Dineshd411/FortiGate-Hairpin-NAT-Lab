...
![IIS Windows Features](images/01-IIS-Windows-Features.png)
![IIS Server IP Configuration](images/02-IIS-Server-IP-Configuration.png)
![IIS Default Page - Initial Test](images/03-IIS-Default-Page-Initial-Test.png)
![IIS Custom Page - Localhost Test](images/04-IIS-Custom-Page-Localhost-Test.png)
...
![FortiGate Interface Summary](images/05-FortiGate-Interface-Summary.png)
![LAN Software Switch Configuration](images/06-LAN-Software-Switch-Configuration.png)
...
![VIP External Address Object](images/07-VIP-External-Address-Object.png)
![External PC Address Object](images/08-External-PC-Address-Object.png)
![LAN Subnet Address Object](images/09-LAN-Subnet-Address-Object.png)
...
![IIS HTTP VIP Configuration](images/10-IIS-HTTP-VIP-Configuration.png)
...
![WAN to LAN IIS Policy](images/11-WAN-to-LAN-IIS-Policy.png)
...
![External PC IP Configuration](images/12-External-PC-IP-Configuration.png)
![External VIP Access Success](images/13-External-VIP-Access-Success.png)
![External VIP TCP Port 80 Test Success](images/13A-External-VIP-TCP-Port-80-Test-Success.png)
...
![PC2 IP Configuration - CLI](images/14-PC2-IP-Configuration-CLI.png)
![PC2 IP Configuration - GUI](images/15-PC2-IP-Configuration-GUI.png)
![Direct LAN Connectivity and HTTP Test](images/16-Direct-LAN-Connectivity-and-HTTP-Test.png)
![Direct LAN Web Access Success](images/17-Direct-LAN-Web-Access-Success.png)
...
![Before Hairpin - VIP Access Failed](images/18-Before-Hairpin-VIP-Access-Failed.png)
...
![Hairpin Policy 1 - LAN to WAN](images/19-Hairpin-Policy-1-LAN-to-WAN.png)
...
![Hairpin Policy 2 - LAN to LAN](images/20-Hairpin-Policy-2-LAN-to-LAN.png)
...
![FortiGate Policy Summary and Hit Counters](images/21-FortiGate-Policy-Summary-and-Hit-Counters.png)
...
![After Hairpin - VIP Access Success](images/22-After-Hairpin-VIP-Access-Success.png)
